...
public:
	...
	void UpdateVehicle(int ch,string& oldmake, string& newmodel, string& newnumberplate, 
						float& newnil, int& newyear, int& new_num_d, int& new_num_s);  // it was on single line...
...
void Manager::UpdateVehicle(int ch, string& oldmake, string& newmodel, 
		string& newnumberplate, float& newmil, int& newyear, int& new_num_d, int& new_num_s) // was on single line
{
	string file;
	if (ch==1)
	{
